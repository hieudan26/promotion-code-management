...
import com.promotion.code.managment.controller.LoginController;
...
public class LoginControllerAdvice {
	...
	ResponseEntity<ApiExceptionResponse> handleRegistrationException(BadCredentialsException exception) {
		...
		final ApiExceptionResponse response = new ApiExceptionResponse(exception.getMessage(), HttpStatus.UNAUTHORIZED, LocalDateTime.now().toString());
